 ...
 */
public class Paging {
	public static String getPaging(String pageURL,int idx, int nowPage, int rowTotal,int blockList, int blockPage){
...
//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if(isPrevPage){
			sb.append("<a href ='"+pageURL+"?idx="+idx+"&page=");
			//sb.append(nowPage - blockPage);
			sb.append( startPage-1 );
			sb.append("' style='text-decoration:none'><img src='/b_log/resources/img/left2_btn.png'></a>");
		}
		else
			sb.append("<img src='/b_log/resources/img/left2_btn.png'>");
...
//-----그룹페이지처리 다음 ----------------------------------------------------------------------------------------------
		if(isNextPage){
			...
			sb.append(nowPage);*/
			sb.append("' style='text-decoration:none'><img src='/b_log/resources/img/right_btn.png'></a>");
		}
		else
			sb.append("<img src='/b_log/resources/img/right_btn.png'>");
//---------------------------------------------------------------------------------------------------------------------	    
